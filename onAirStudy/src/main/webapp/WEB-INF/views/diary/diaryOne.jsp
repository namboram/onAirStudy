...
<div id="memo-container">
    <form id="memoEnrollFrm" 
    	  action="${pageContext.request.contextPath}/memo/insertMemo.do" 
    	  class="form-inline" 
    	  method="post">
        <select name ="title">
        ...
        <input type="text" class="form-control col-sm-6" name="search" placeholder="검색할 키워드를 입력하세요" required/>&nbsp;
	    ...
	    <tr>
	      ...
	      <td>
	      	<button 
	      		...
	      		onclick="deleteMemo('${ memo.no }')">삭제</button>
	      </td>
		</tr>
	    </c:forEach>
	</table>
