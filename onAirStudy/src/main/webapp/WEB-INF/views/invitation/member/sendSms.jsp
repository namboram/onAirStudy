...
<form action="<%=request.getContextPath() %>/member/sendSms" 
	  method="post" 
	  name="phone-certification" >
   	    휴대폰번호 : <input type="text" id="to" name="to"/>   <!-- 인증번호 받을사람 휴대폰 번호 -->
	    	<input type="button" id="send" value="전송" onclick="sendSMS('sendSms')"/><br> <!-- 문자보내는 전송버튼 -->
  ...
  function sendSMS(pageName){
		console.log("휴대폰본인인증문자 전송");
		$("[name=phone-certification]").attr("action",pageName+".do");
		$("[name=phone-certification]").submit();
	}
