...
<body>
  ...
  <div class="invitation" style="margin-bottom: 0;">
    ...
    <div class="row">
      <div class="col-sm-3" style="background-color:#AD8686;">사이드 메뉴</div>
      <div class="col-sm-9" style="background-color:#FBF7FD; padding: 20px;">
            ...
            <table class="table">
              ...
              <tbody>
                 <c:forEach items="${ inList }" var="invitation"> 
                  <tr>
                   	<td>${invitation.no}</td>                    
                    <td>${invitation.srTitle}</td>
                    <td>${invitation.srGoal}</td> 
