...
<div class="row">
	...
	<div class="col-lg-10 p-0" id="member-update-container" style="height:80%;">
		<div style="padding:5%;">
			...
			<div id="updatefrm-left2" style="margin-bottom:10%;">
				...
				<form id="memberUpdateFrm1" 
					...
					<div class="input">
						<input type="text" class="forminput" placeholder="아이디" name="memberId" id="memberId" value="${ loginMember.memberId }"  readonly/>
						<label for="input">
							<span class="content-member-detail"></span>
						</label>
					</div>
					
					
					<input type="text" class="forminput" placeholder="비밀번호" name="password" id="password_" value="${ loginMember.password }" required />
					<input type="password" class="forminput" placeholder="비밀번호체크" name="passwordCheck" id="passwordCheck_" value="${ loginMember.password }" required/>
					<input type="text" class="forminput" placeholder="이름" name="memberName" id="memberName" value="${ loginMember.memberName }" readonly />
					<input type="tel" class="forminput" placeholder="전화번호 (예:01012345678)" name="phone" id="phone" maxlength="11" value="${ loginMember.phone }" required />
					<input type="text" class="forminput" placeholder="자기소개" name="comment" id="comment" value="${ loginMember.comment }" />
		...
		<div id="paymentlistfrm-right" style="margin-bottom:10%;">
			<h5>결제 내역</h5>
...
function MupdateValidate(){
	...
	//자기소개
	if(/^[ㄱ-ㅎ가-힣A-Za-z~!@#$%^&*()_+|<>?:{}]{0,20}$/.test($("#comment").val())) {
