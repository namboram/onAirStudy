...
<div class="row">
	...
	<h3>
		오늘의 To Do List
		<button type="button" class="btn btn-light" onclick="location.href='${ pageContext.request.contextPath }/scheduler/main.do'">캘린더 보기</button>
	</h3>
</div>	
	...
	<h3>
		...
		<button type="button" class="btn btn-primary" 
				...
				data-whatever="@getbootstrap">시간 등록하기</button>
	</h3>
	<div class="col-md-7">
	<div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="form">
          ...
          <div class="form-group">
            <label for="message-text" class="col-form-label">공부한 시간</label>
            <input type="number" class="form-control" id="studyTime">
          </div>
        </form>
      </div>
